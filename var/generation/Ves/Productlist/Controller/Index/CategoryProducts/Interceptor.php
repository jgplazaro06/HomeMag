...
class Interceptor extends \Ves\Productlist\Controller\Index\CategoryProducts implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\App\Action\Context $context, \Magento\Framework\View\Result\PageFactory $resultPageFactory, \Magento\Catalog\Model\Category $categoryModel)
    {
        $this->___init();
        parent::__construct($context, $resultPageFactory, $categoryModel);
    }
